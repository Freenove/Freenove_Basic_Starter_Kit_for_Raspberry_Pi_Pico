...
Open the " **Freenove_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico\\C\\Sketches\\Sketch_14.1_WiFiClient\\sketchWiFi\\sketchWiFi.pde** ", and click "Run".
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/13.1_TCP_as_Client/13.1_TCP_as_Client.py
    :linenos: 
    :language: python
    :lines: 1-43
    :dedent:
...
Open the "Freenove_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico/Codes/MicroPython_Codes/13.2_TCP_as_Server/
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/13.2_TCP_as_Server/13.2_TCP_as_Server.py
    :linenos: 
    :language: python
    :lines: 1-53
    :dedent:
